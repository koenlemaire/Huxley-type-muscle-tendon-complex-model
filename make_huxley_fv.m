...
scaletmp=100; % drastically reduces computation time while hardly affecting results, very worthwhile implementing it seems ...
parms.scale_factor = s/(2*h)/scaletmp; % [] scaling between x and lcerel
parms.dx=.01; % [h] stepsize in x
parms.f1=0.9237*100/scaletmp;
parms.g1=7.0773*100/scaletmp;
parms.g2=12.7213*100/scaletmp;
parms.g3=3.8875*100/scaletmp;
